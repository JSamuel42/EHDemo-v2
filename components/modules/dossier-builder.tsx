...
function DossierListContent() {
  ...
  function handleCreated(dossier: DossierSummary) {
    ...
    router.push(`${moduleHref(productId, 'dossier-builder')}/${dossier.id}`);
  }
  ...
  return (
    <div className="px-8 py-7">
      ...
      <div className="flex items-start justify-between gap-4 mb-6">
        <div>
          <h1 className="font-sans text-3xl text-serif-foreground">Dossier Builder</h1>
      ...
      {isLoading ? (
        ...
        <div className="max-w-md mx-auto mt-8">
          <Card accentTop className="flex flex-col items-center gap-4 py-16 text-center">
            ...
            <div>
              <p
                className="font-sans text-lg font-normal mb-1"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          >
            ...
            <span className="font-sans text-base" style={{ color: 'var(--serif-foreground)' }}>
              Add another
            </span>
...
export default function DossierBuilderModule() {
  return (
    <DossierSeeder>
      <DossierListContent />
    </DossierSeeder>
