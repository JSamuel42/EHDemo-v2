          ...
          <div className="max-w-3xl mx-auto py-8 px-12">
                ...
                {section.currentContent ? (
                  <>
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: linkifyCitations(section.currentContent.content, section.articleLinks, productId) }}
                    />
                    <style>{`
                      .prose-compiled p { margin-bottom: 0.75em; }
                      .prose-compiled h2, .prose-compiled h3 { font-family: var(--font-source-sans, sans-serif); font-weight: 400; margin: 1em 0 0.5em; }
            ...
            {allLinks.length > 0 && (
              <div data-section-id="__references" className="mt-12 pt-8" style={{ borderTop: '1px solid var(--serif-border)' }}>
                <h2 className="font-sans text-2xl font-normal mb-6" style={{ color: 'var(--serif-foreground)' }}>
                  References
                </h2>
