...
import { ISTENT_ARTICLES as ARTICLES } from '@/lib/library/istent-data';
import type { Funnel } from '@/lib/epidemiology/istent-data';
...
export function PublicationsModal({ funnel, level, onClose }: Props) {
  // Resolve full iStent Library articles by ID. Tagging is curated per
  // country/level in lib/epidemiology/istent-data.ts; most combinations are
